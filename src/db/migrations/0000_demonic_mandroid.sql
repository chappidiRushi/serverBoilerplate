...
CREATE INDEX "UserGroup_groupId_idx" ON "UserGroup" USING btree ("groupId" text_ops);--> statement-breakpoint
...
CREATE UNIQUE INDEX "WarehouseCartItem_warehouseId_supplierId_potCategoryId_potV_key" ON "WarehouseCartItem" USING btree ("warehouseId" text_ops,"supplierId" text_ops,"potCategoryId" text_ops,"potVariantId" text_ops);